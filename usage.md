...
- [複数の本をまとめて所持に設定する](usage/usage003.html)
- [バーコードで登録した本の情報を表示する方法](usage/usage004.html)
- [バーコードで本を登録して購入予定にする方法](usage/usage005.html)
- [バーコードで連続で本を登録する方法](usage/usage006.html)
